...
function JD(y, m, d){ // calculates Julian ephemeris given Gregorian date
...
function direction(bearing) { // returns the compass direction (ex. SW) given the compass bearing (ex. 225 degrees)
