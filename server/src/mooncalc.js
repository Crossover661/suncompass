...
export function moonLatLong(date, unix = false) {
    if (!unix) {
...
export function moonDistance(date, unix = false) {
    if (!unix) {
...
export function sublunarPoint(unix) {
