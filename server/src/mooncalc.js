...
function deltaB(JC) {
    var a = a(JC);
    return -2235*sin(moonMeanLongitude(JC)*degToRad) + 382*Math.sin(a[2]*degToRad) + 175*Math.sin((a[0]-moonArgLat(JC))*degToRad) + 175*Math.sin((a[0]+moonArgLat(JC))*degToRad) + 127*Math.sin((moonMeanLongitude(JC)-moonMeanAnomaly(JC))*degToRad) - 115*Math.sin((moonMeanLongitude(JC)+moonMeanAnomaly(JC))*degToRad);
}
