...
function JD(y, m, d){ // calculates Julian Day Number given Gregorian date
...
function JDNdate(date) {
    // gets Julian Day Number (including fractional part) given a Luxon DateTime object
    var year = date.year;
...
function direction(bearing) { // returns the compass direction (ex. SW) given the compass bearing (ex. 221 degrees)
...
export {degToRad, intDiv, clamp, mod, JD, JDN, JDNdate, mins, julianCentury, direction};