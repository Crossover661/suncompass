...
console.log("March equinox: " + mar.toLocaleString(DateTime.DATETIME_FULL_WITH_SECONDS));
console.log("Subsolar point: " + marSSP[0].toFixed(4) + ", " + marSSP[1].toFixed(4));
console.log();

console.log("June solstice: " + jun.toLocaleString(DateTime.DATETIME_FULL_WITH_SECONDS));
console.log("Subsolar point: " + junSSP[0].toFixed(4) + ", " + junSSP[1].toFixed(4));
console.log();

console.log("September equinox: " + sep.toLocaleString(DateTime.DATETIME_FULL_WITH_SECONDS));
console.log("Subsolar point: " + sepSSP[0].toFixed(4) + ", " + sepSSP[1].toFixed(4));
console.log();

console.log("December solstice: " + dec.toLocaleString(DateTime.DATETIME_FULL_WITH_SECONDS));
